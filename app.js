...
function onThemeSelect(e){
  ...
  const isConfirmed = confirm(`Вы дейстительно хотите изменить тему на ${selectedTheme}?`);
  if(!isConfirmed) {
